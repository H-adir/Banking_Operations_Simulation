...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        SavingsAccount savings = new SavingsAccount("Alice", 1001, 1000.0);
        CheckingAccount checking = new CheckingAccount("Bob", 1002, 500.0);
        BusinessAccount business = new BusinessAccount("Charlie", 1003, 2000.0);
        ...
        // Création de la scène et application du style CSS
